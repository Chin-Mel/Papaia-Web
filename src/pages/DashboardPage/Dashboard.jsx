...
const Dashboard = () => {
  ...
  const Button = ({
    ...
    const variants = {
      primary:
        "bg-button-1 text-button-1 hover:bg-[#005a24] disabled:bg-gray-400",
      secondary:
              ...
              <div className="stats-cards">
                <div className="stats-card bg-global-5">
                  <div className="stats-card-content">
                    <div className="stats-top">
                      <img
                        src="/images/img_icons8_farmer_64.png"
                        alt="Farmers"
                        className="icon"
                      />
                ...
                <div className="stats-card bg-global-2">
                  <div className="stats-card-content">
                    <div className="stats-top">
                      <img
                        src="/images/img_icons8_farm_2_50.png"
                        alt="Farms"
                        className="icon"
                      />
                      <span className="stats-number">25</span>
                ...
                <div className="stats-card bg-global-4">
                  <div className="stats-card-content">
                    <div className="stats-top">
                      <img
                        src="/images/img_icons8_scan_64_1.png"
                        alt="Scan"
                        className="icon"
                      />
                      <span className="stats-number">25</span>
                      ...
                      <div key={farm.id} className="farm-card bg-global-6">
                        <div className="farm-card-content">
                          ...
                          <div className="farm-location">
                            <img
                              src="/images/img_location_on.svg"
                              alt="Location"
