...
import Footer from "../components/Footer/FooterStart";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50">
      ...
      <div className="py-8 lg:py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="inline-flex items-center gap-3 bg-white rounded-full p-1 shadow-md">
            <button
              ...
              className={`px-4 lg:px-6 py-2 rounded-full font-medium transition-all text-sm lg:text-base ${
                !isAnnual
          ...
          {isAnnual && (
            <p className="text-green-600 font-semibold mt-3 animate-pulse text-sm lg:text-base">
        ...
        <div className="text-center mb-6 lg:hidden bg-green-600 text-white p-6 rounded-b-3xl -mt-8 shadow-lg">
        ...
        <div className="flex justify-center mb-6 lg:hidden">
          <div className="inline-flex items-center gap-2 bg-white rounded-full p-1 shadow-md">
            ...
            <button
              onClick={() => setIsAnnual(true)}
              className={`px-4 py-1.5 rounded-full font-medium transition-all text-sm ${
                isAnnual ? "bg-green-600 text-white shadow-sm" : "text-gray-600"
              }`}
            >
              Annual
            </button>
        ...
        {isAnnual && (
          <p className="text-green-600 font-semibold text-center mb-6 text-sm lg:hidden">
            🎉 Save 50%!
          </p>
        )}
        ...
        <div className="mt-12 lg:mt-20 max-w-3xl mx-auto">
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            <div className="bg-white rounded-xl p-4 lg:p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm lg:text-base">
                Yes, we offer a 14-day free trial for both Pro and Farm Manager
