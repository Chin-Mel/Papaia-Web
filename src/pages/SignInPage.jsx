    ...
    <div className="min-h-screen w-full overflow-x-hidden">
      ...
      <main>
        <section className="relative h-[90vh] sm:h-[100vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl mx-4 sm:mx-6 lg:mx-auto px-4 sm:px-6 lg:px-12 py-8 sm:py-12 lg:py-16 text-center mt-8 sm:mt-16 lg:mt-20">
