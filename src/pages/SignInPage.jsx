...
// Simple encryption utility (better than plain text, but not truly secure)
...
export default function SignInPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ⚠️ REMOVED: console.log statements that expose sensitive data
      ...
      // Additional role check - only allow owners
      ...
      // ✅ Store JWT token using encrypted storage
      if (loginData.token) {
        secureStorage.setItem("token", loginData.token);
      }

      // ✅ Store user info using encrypted storage
      if (loginData.user) {
        secureStorage.setItem("user", loginData.user);
      }
