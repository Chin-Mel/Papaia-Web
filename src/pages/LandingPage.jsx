...
const FeatureCard = memo(
  ({ icon: IconComponent, title, description, index }) => (
    <div className="flex flex-col items-center text-center space-y-4">
      ...
      <h3 className="text-lg sm:text-xl font-bold text-[#2D5016]">{title}</h3>
...
export default function LandingPage() {
  ...
  useEffect(() => {
    preloadImages([MainBackground, ArrowIconPNG]);
  }, []);
    ...
    <div className="min-h-screen w-full overflow-x-hidden">
      ...
      <main>
        ...
        <section className="relative h-[90vh] sm:h-[100vh] flex items-center justify-center overflow-hidden">
          ...
          >
            {/* Preload the background image as high priority */}
            <link
              rel="preload"
              as="image"
              href={MainBackground}
