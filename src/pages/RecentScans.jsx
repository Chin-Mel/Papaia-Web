...
//           // Show ALL scans from the farm - no farmer filtering
//           const farmScans = (scansData || [])
//             .filter((scan) => !!scan.idNumber) // Only filter out scans without idNumber
//             .sort((a, b) => {
...
//     (scan) => {
//       // Use farmerName from scan API first (for archived farmers)
//       if (scan.farmerName) {
//         return scan.farmerName;
//       }

//       // Fall back to lookup in active farmers list
