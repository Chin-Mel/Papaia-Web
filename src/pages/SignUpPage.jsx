...
// Custom debounce hook for validation
  ...
  ({
    ...
    <div className="space-y-2">
      <label className="text-sm font-semibold text-gray-700 flex items-center gap-2">
        <img src={icon} className="w-4 h-4" alt="" width="16" height="16" />
      ...
      <input
        ...
        focus:outline-none focus:ring-2 focus:ring-orange-500 ${borderClass}`}
      />
    </div>
  )
);
...
export default function SignUpPage() {
  ...
  const validatePhoneNumber = useCallback(
    (value) => /^[0-9]{10,11}$/.test(value.replace(/[\s-]/g, "")),
    []
  );

  // Debounced validation
  const debouncedEmailValidation = useDebounce((value) => {
    if (value && !validateEmail(value)) {
      showAlert("error", "Invalid email format.");
    }
  }, 500);

  const debouncedPasswordMatch = useDebounce((pwd, confirmPwd) => {
  ...
  useEffect(() => {
    if (touched.email && email.trim()) {
      debouncedEmailValidation(email.trim());
    }
  ...
  useEffect(() => {
    if (
      ...
      debouncedPasswordMatch(password.trim(), confirmPassword.trim());
    }
  }, [
    password,
    confirmPassword,
  ...
  // Handle modal agree
  const handleModalAgree = useCallback(() => {
    setIsChecked(true);
  }, []);

  // Register user API call with AbortController
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <InputField
                  ...
                  borderClass={getBorderClass("firstName", firstName)}
                />
                ...
                <InputField
                  ...
                  borderClass={getBorderClass("lastName", lastName)}
                />
                ...
                <InputField
                  ...
                  borderClass={getBorderClass("username", username)}
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                <InputField
                  ...
                  autoComplete="email"
                  borderClass={getBorderClass("email", email)}
                />
                ...
                <InputField
                  ...
                  autoComplete="tel"
                  borderClass={getBorderClass("phoneNumber", phoneNumber)}
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                <PasswordField
                  ...
                  borderClass={getBorderClass("password", password)}
