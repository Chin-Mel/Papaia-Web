...
// import { Bell, AlertTriangle, ArrowLeft, Check } from "lucide-react";
...
//             <button
//               onClick={() => navigate(-1)}
//               className="flex items-center gap-2 text-[#4A7C59] hover:text-[#2D5016] mb-4 transition-colors"
//             >
...
//                       } p-4 sm:p-5 hover:bg-gray-50 transition-all relative`}
//                     >
