    ...
    try {
      ...
      if (response.ok) {
        ...
        if (
          ...
          showAlert(
            "error",
            "This email is registered as a farmer account. Please use the Papaia mobile app."
          );
        } else if (
          ...
          <div className="relative z-10 w-full max-w-lg sm:max-w-md mx-auto mt-18 sm:mt-20 rounded-2xl shadow-[0_25px_50px_rgba(0,0,0,0.35)] overflow-hidden">
            ...
            >
              <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-xl mb-3 ring-4 ring-white/30">
                <img src={PapayaLogo} alt="Papaia Logo" className="w-7 h-9" />
              </div>
            ...
            <div className="bg-white p-6 sm:p-8 flex flex-col">
              ...
              <input
                ...
                autoComplete="email"
                className="transition-all duration-150 w-full px-4 py-2 border-2 border-[#E5E7EB] rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400"
              />
