      ...
      >
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white transition-all"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white transition-all"
                placeholder="Sonoma County, California"
                disabled={isLoading}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white resize-none transition-all"
              placeholder="Green Valley Organic Farm is a 125-acre sustainable agriculture operation specializing in organic vegetables and herbs..."
              disabled={isLoading}
            />
          </div>
        </div>
        ...
        <div className="p-6 border-t-2 border-gray-100 flex flex-col sm:flex-row gap-3 justify-end">
          ...
          <button
            onClick={handleSave}
            disabled={isLoading}
            className="px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl font-bold hover:from-orange-600 hover:to-orange-700 transition-all shadow-lg hover:shadow-xl active:scale-95 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <>
